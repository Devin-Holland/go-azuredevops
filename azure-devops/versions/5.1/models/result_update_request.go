...
// ResultUpdateRequest result update request
// swagger:model ResultUpdateRequest
type ResultUpdateRequest struct {

	// action result deletes
	ActionResultDeletes []*TestActionResult `json:"actionResultDeletes"`

	// action results
	ActionResults []*TestActionResult `json:"actionResults"`

	// attachment deletes
	AttachmentDeletes []*TestResultAttachmentIdentity `json:"attachmentDeletes"`

	// attachments
	Attachments []*TestResultAttachment `json:"attachments"`

	// parameter deletes
	ParameterDeletes []*TestResultParameter `json:"parameterDeletes"`

	// parameters
	Parameters []*TestResultParameter `json:"parameters"`
...
// Validate validates this result update request
func (m *ResultUpdateRequest) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateAttachmentDeletes(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ResultUpdateRequest) validateActionResultDeletes(formats strfmt.Registry) error {
...
func (m *ResultUpdateRequest) validateActionResults(formats strfmt.Registry) error {
...
func (m *ResultUpdateRequest) validateAttachmentDeletes(formats strfmt.Registry) error {

	if swag.IsZero(m.AttachmentDeletes) { // not required
		return nil
	}

	for i := 0; i < len(m.AttachmentDeletes); i++ {
		if swag.IsZero(m.AttachmentDeletes[i]) { // not required
			continue
		}

		if m.AttachmentDeletes[i] != nil {
			if err := m.AttachmentDeletes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("attachmentDeletes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *ResultUpdateRequest) validateAttachments(formats strfmt.Registry) error {
...
func (m *ResultUpdateRequest) validateParameterDeletes(formats strfmt.Registry) error {
...
func (m *ResultUpdateRequest) validateParameters(formats strfmt.Registry) error {
...
func (m *ResultUpdateRequest) validateTestCaseResult(formats strfmt.Registry) error {
...
func (m *ResultUpdateRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResultUpdateRequest) UnmarshalBinary(b []byte) error {
	var res ResultUpdateRequest
