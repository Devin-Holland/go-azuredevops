...
// UPackPackagesBatchRequest A batch of operations to apply to package versions.
// swagger:model UPackPackagesBatchRequest
...
// Validate validates this u pack packages batch request
func (m *UPackPackagesBatchRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UPackPackagesBatchRequest) validatePackages(formats strfmt.Registry) error {
...
func (m *UPackPackagesBatchRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UPackPackagesBatchRequest) UnmarshalBinary(b []byte) error {
	var res UPackPackagesBatchRequest
