...
// TaskGroupUpdateParameter task group update parameter
// swagger:model TaskGroupUpdateParameter
...
// Validate validates this task group update parameter
func (m *TaskGroupUpdateParameter) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TaskGroupUpdateParameter) validateID(formats strfmt.Registry) error {
...
func (m *TaskGroupUpdateParameter) validateInputs(formats strfmt.Registry) error {
...
func (m *TaskGroupUpdateParameter) validateParentDefinitionID(formats strfmt.Registry) error {
...
func (m *TaskGroupUpdateParameter) validateTasks(formats strfmt.Registry) error {
...
func (m *TaskGroupUpdateParameter) validateVersion(formats strfmt.Registry) error {
...
func (m *TaskGroupUpdateParameter) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TaskGroupUpdateParameter) UnmarshalBinary(b []byte) error {
	var res TaskGroupUpdateParameter
