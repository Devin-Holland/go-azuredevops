...
// PyPiPackagesBatchRequest A batch of operations to apply to package versions.
// swagger:model PyPiPackagesBatchRequest
...
// Validate validates this py pi packages batch request
func (m *PyPiPackagesBatchRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PyPiPackagesBatchRequest) validatePackages(formats strfmt.Registry) error {
...
func (m *PyPiPackagesBatchRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PyPiPackagesBatchRequest) UnmarshalBinary(b []byte) error {
	var res PyPiPackagesBatchRequest
