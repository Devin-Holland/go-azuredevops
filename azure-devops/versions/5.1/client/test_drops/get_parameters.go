...
// WithTestDropID adds the testDropID to the get params
func (o *GetParams) WithTestDropID(testDropID string) *GetParams {
	o.SetTestDropID(testDropID)
	return o
}

// SetTestDropID adds the testDropId to the get params
func (o *GetParams) SetTestDropID(testDropID string) {
	o.TestDropID = testDropID
}
...
func (o *GetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param testDropId
	if err := r.SetPathParam("testDropId", o.TestDropID); err != nil {
		return err
	}
