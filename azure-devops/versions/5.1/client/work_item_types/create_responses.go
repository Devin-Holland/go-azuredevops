...
type CreateOK struct {
	Payload *models.ProcessWorkItemType
}

func (o *CreateOK) Error() string {
	return fmt.Sprintf("[POST /{organization}/_apis/work/processes/{processId}/workitemtypes][%d] createOK  %+v", 200, o.Payload)
}

func (o *CreateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ProcessWorkItemType)
