...
type CreateParams struct {
	...
	*/
	APIVersion string
	/*Body*/
	Body *models.CreateProcessWorkItemTypeRequest
	/*Organization
...
func (o *CreateParams) WithBody(body *models.CreateProcessWorkItemTypeRequest) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.CreateProcessWorkItemTypeRequest) {
	o.Body = body
}
...
// WithProcessID adds the processID to the create params
func (o *CreateParams) WithProcessID(processID strfmt.UUID) *CreateParams {
	o.SetProcessID(processID)
	return o
}

// SetProcessID adds the processId to the create params
func (o *CreateParams) SetProcessID(processID strfmt.UUID) {
