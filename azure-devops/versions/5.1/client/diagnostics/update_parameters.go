...
type UpdateParams struct {
	...
	*/
	APIVersion string
	/*Body*/
	Body *models.UpdateSubscripitonDiagnosticsParameters
	/*Organization
...
func (o *UpdateParams) WithBody(body *models.UpdateSubscripitonDiagnosticsParameters) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.UpdateSubscripitonDiagnosticsParameters) {
	o.Body = body
}
...
// WithSubscriptionID adds the subscriptionID to the update params
func (o *UpdateParams) WithSubscriptionID(subscriptionID string) *UpdateParams {
	o.SetSubscriptionID(subscriptionID)
	return o
}

// SetSubscriptionID adds the subscriptionId to the update params
func (o *UpdateParams) SetSubscriptionID(subscriptionID string) {
