...
type UpdateOK struct {
	Payload *models.SubscriptionDiagnostics
}

func (o *UpdateOK) Error() string {
	return fmt.Sprintf("[PUT /{organization}/_apis/hooks/subscriptions/{subscriptionId}/diagnostics][%d] updateOK  %+v", 200, o.Payload)
}

func (o *UpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.SubscriptionDiagnostics)
