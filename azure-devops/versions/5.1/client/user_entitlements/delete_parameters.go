...
// WithUserID adds the userID to the delete params
func (o *DeleteParams) WithUserID(userID strfmt.UUID) *DeleteParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the delete params
func (o *DeleteParams) SetUserID(userID strfmt.UUID) {
	o.UserID = userID
}
