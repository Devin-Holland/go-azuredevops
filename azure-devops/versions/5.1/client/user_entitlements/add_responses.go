...
*/
type AddOK struct {
	Payload *models.UserEntitlementsPostResponse
}

func (o *AddOK) Error() string {
	return fmt.Sprintf("[POST /{organization}/_apis/userentitlements][%d] addOK  %+v", 200, o.Payload)
}

func (o *AddOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.UserEntitlementsPostResponse)
