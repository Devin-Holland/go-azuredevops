...
func (o *ListOK) Error() string {
	return fmt.Sprintf("[POST /_apis/tokenadministration/tokenpersonalaccesstokens/{subjectDescriptor}][%d] listOK  %+v", 200, o.Payload)
}
...
func (o *ListBadRequest) Error() string {
	return fmt.Sprintf("[POST /_apis/tokenadministration/tokenpersonalaccesstokens/{subjectDescriptor}][%d] listBadRequest ", 400)
}
...
func (o *ListUnauthorized) Error() string {
	return fmt.Sprintf("[POST /_apis/tokenadministration/tokenpersonalaccesstokens/{subjectDescriptor}][%d] listUnauthorized ", 401)
}
...
func (o *ListNotFound) Error() string {
	return fmt.Sprintf("[POST /_apis/tokenadministration/tokenpersonalaccesstokens/{subjectDescriptor}][%d] listNotFound ", 404)
}
