...
// WithGroupID adds the groupID to the update params
func (o *UpdateParams) WithGroupID(groupID strfmt.UUID) *UpdateParams {
	o.SetGroupID(groupID)
	return o
}

// SetGroupID adds the groupId to the update params
func (o *UpdateParams) SetGroupID(groupID strfmt.UUID) {
	o.GroupID = groupID
}
...
// WithRuleOption adds the ruleOption to the update params
func (o *UpdateParams) WithRuleOption(ruleOption *string) *UpdateParams {
	o.SetRuleOption(ruleOption)
	return o
}

// SetRuleOption adds the ruleOption to the update params
func (o *UpdateParams) SetRuleOption(ruleOption *string) {
	o.RuleOption = ruleOption
}
...
func (o *UpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.RuleOption != nil {
		...
		// query param ruleOption
		var qrRuleOption string
		if o.RuleOption != nil {
			qrRuleOption = *o.RuleOption
		}
		qRuleOption := qrRuleOption
		if qRuleOption != "" {
			if err := r.SetQueryParam("ruleOption", qRuleOption); err != nil {
				return err
			}
		}
