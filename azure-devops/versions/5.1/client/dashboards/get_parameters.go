...
// WithDashboardID adds the dashboardID to the get params
func (o *GetParams) WithDashboardID(dashboardID strfmt.UUID) *GetParams {
	o.SetDashboardID(dashboardID)
	return o
}

// SetDashboardID adds the dashboardId to the get params
func (o *GetParams) SetDashboardID(dashboardID strfmt.UUID) {
