...
type CreateParams struct {
	...
	*/
	Body *models.TokenAdminRevocationRule
	/*Organization
...
func (o *CreateParams) WithBody(body *models.TokenAdminRevocationRule) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.TokenAdminRevocationRule) {
	o.Body = body
}
