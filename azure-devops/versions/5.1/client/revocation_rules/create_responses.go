...
The revocation rule was created successfully.
*/
type CreateCreated struct {
}

func (o *CreateCreated) Error() string {
	return fmt.Sprintf("[POST /{organization}/_apis/tokenadmin/revocationrules][%d] createCreated ", 201)
}
...
The input is invalid, such as by not containing a scope.
*/
type CreateBadRequest struct {
}

func (o *CreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /{organization}/_apis/tokenadmin/revocationrules][%d] createBadRequest ", 400)
}
...
func (o *CreateUnauthorized) Error() string {
	return fmt.Sprintf("[POST /{organization}/_apis/tokenadmin/revocationrules][%d] createUnauthorized ", 401)
}
