...
func (o *UpdateParams) WithBody(body *models.TestRun) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.TestRun) {
	o.Body = body
}
...
// WithTestRunID adds the testRunID to the update params
func (o *UpdateParams) WithTestRunID(testRunID string) *UpdateParams {
	o.SetTestRunID(testRunID)
	return o
}

// SetTestRunID adds the testRunId to the update params
func (o *UpdateParams) SetTestRunID(testRunID string) {
