...
// WithDeep adds the deep to the delete params
func (o *DeleteParams) WithDeep(deep *bool) *DeleteParams {
	o.SetDeep(deep)
	return o
}

// SetDeep adds the deep to the delete params
func (o *DeleteParams) SetDeep(deep *bool) {
	o.Deep = deep
}

// WithEndpointID adds the endpointID to the delete params
func (o *DeleteParams) WithEndpointID(endpointID strfmt.UUID) *DeleteParams {
	o.SetEndpointID(endpointID)
	return o
}

// SetEndpointID adds the endpointId to the delete params
func (o *DeleteParams) SetEndpointID(endpointID strfmt.UUID) {
