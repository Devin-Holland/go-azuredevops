...
// WithUserDescriptor adds the userDescriptor to the delete params
func (o *DeleteParams) WithUserDescriptor(userDescriptor string) *DeleteParams {
	o.SetUserDescriptor(userDescriptor)
	return o
}

// SetUserDescriptor adds the userDescriptor to the delete params
func (o *DeleteParams) SetUserDescriptor(userDescriptor string) {
