...
type ListOK struct {
	...
	Payload []*models.GraphUser
}

func (o *ListOK) Error() string {
	return fmt.Sprintf("[GET /{organization}/_apis/graph/users][%d] listOK  %+v", 200, o.Payload)
}

func (o *ListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	// response header X-MS-ContinuationToken
	o.XMSContinuationToken = response.GetHeader("X-MS-ContinuationToken")
