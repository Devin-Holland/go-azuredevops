...
// WithTestVariableID adds the testVariableID to the get params
func (o *GetParams) WithTestVariableID(testVariableID int32) *GetParams {
	o.SetTestVariableID(testVariableID)
	return o
}

// SetTestVariableID adds the testVariableId to the get params
func (o *GetParams) SetTestVariableID(testVariableID int32) {
