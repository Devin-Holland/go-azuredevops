...
// WithTestVariableID adds the testVariableID to the delete params
func (o *DeleteParams) WithTestVariableID(testVariableID int32) *DeleteParams {
	o.SetTestVariableID(testVariableID)
	return o
}

// SetTestVariableID adds the testVariableId to the delete params
func (o *DeleteParams) SetTestVariableID(testVariableID int32) {
