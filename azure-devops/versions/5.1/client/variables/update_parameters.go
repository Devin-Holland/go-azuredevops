...
type UpdateParams struct {
	...
	*/
	Body *models.TestVariableCreateUpdateParameters
	/*Organization
...
func (o *UpdateParams) WithBody(body *models.TestVariableCreateUpdateParameters) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.TestVariableCreateUpdateParameters) {
	o.Body = body
}
...
// WithTestVariableID adds the testVariableID to the update params
func (o *UpdateParams) WithTestVariableID(testVariableID int32) *UpdateParams {
	o.SetTestVariableID(testVariableID)
	return o
}

// SetTestVariableID adds the testVariableId to the update params
func (o *UpdateParams) SetTestVariableID(testVariableID int32) {
	o.TestVariableID = testVariableID
}
...
func (o *UpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param testVariableId
	if err := r.SetPathParam("testVariableId", swag.FormatInt32(o.TestVariableID)); err != nil {
		return err
	}
