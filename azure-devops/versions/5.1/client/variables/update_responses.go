...
type UpdateOK struct {
	Payload *models.TestVariable
}

func (o *UpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /{organization}/{project}/_apis/testplan/variables/{testVariableId}][%d] updateOK  %+v", 200, o.Payload)
}

func (o *UpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.TestVariable)
