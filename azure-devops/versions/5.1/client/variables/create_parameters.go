...
func (o *CreateParams) WithBody(body *models.TestVariableCreateUpdateParameters) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.TestVariableCreateUpdateParameters) {
	o.Body = body
}
