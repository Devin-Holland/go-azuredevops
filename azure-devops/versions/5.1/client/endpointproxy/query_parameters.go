...
func (o *QueryParams) WithBody(body *models.DataSourceBinding) *QueryParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the query params
func (o *QueryParams) SetBody(body *models.DataSourceBinding) {
	o.Body = body
}
