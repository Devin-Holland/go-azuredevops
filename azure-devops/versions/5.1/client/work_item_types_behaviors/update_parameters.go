...
type UpdateParams struct {
	...
	*/
	APIVersion string
	/*Body*/
	Body *models.WorkItemTypeBehavior
	/*Organization
...
func (o *UpdateParams) WithBody(body *models.WorkItemTypeBehavior) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.WorkItemTypeBehavior) {
	o.Body = body
}
...
// WithProcessID adds the processID to the update params
func (o *UpdateParams) WithProcessID(processID strfmt.UUID) *UpdateParams {
	o.SetProcessID(processID)
	return o
}

// SetProcessID adds the processId to the update params
func (o *UpdateParams) SetProcessID(processID strfmt.UUID) {
	o.ProcessID = processID
}

// WithWitRefNameForBehaviors adds the witRefNameForBehaviors to the update params
func (o *UpdateParams) WithWitRefNameForBehaviors(witRefNameForBehaviors string) *UpdateParams {
	o.SetWitRefNameForBehaviors(witRefNameForBehaviors)
	return o
}

// SetWitRefNameForBehaviors adds the witRefNameForBehaviors to the update params
func (o *UpdateParams) SetWitRefNameForBehaviors(witRefNameForBehaviors string) {
