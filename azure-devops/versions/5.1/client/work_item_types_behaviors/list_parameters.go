...
// WithWitRefNameForBehaviors adds the witRefNameForBehaviors to the list params
func (o *ListParams) WithWitRefNameForBehaviors(witRefNameForBehaviors string) *ListParams {
	o.SetWitRefNameForBehaviors(witRefNameForBehaviors)
	return o
}

// SetWitRefNameForBehaviors adds the witRefNameForBehaviors to the list params
func (o *ListParams) SetWitRefNameForBehaviors(witRefNameForBehaviors string) {
