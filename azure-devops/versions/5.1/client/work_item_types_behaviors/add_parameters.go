...
func (o *AddParams) WithBody(body *models.WorkItemTypeBehavior) *AddParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add params
func (o *AddParams) SetBody(body *models.WorkItemTypeBehavior) {
	o.Body = body
}
...
// WithProcessID adds the processID to the add params
func (o *AddParams) WithProcessID(processID strfmt.UUID) *AddParams {
	o.SetProcessID(processID)
	return o
}

// SetProcessID adds the processId to the add params
func (o *AddParams) SetProcessID(processID strfmt.UUID) {
	o.ProcessID = processID
}

// WithWitRefNameForBehaviors adds the witRefNameForBehaviors to the add params
func (o *AddParams) WithWitRefNameForBehaviors(witRefNameForBehaviors string) *AddParams {
	o.SetWitRefNameForBehaviors(witRefNameForBehaviors)
	return o
}

// SetWitRefNameForBehaviors adds the witRefNameForBehaviors to the add params
func (o *AddParams) SetWitRefNameForBehaviors(witRefNameForBehaviors string) {
