...
type UpdateParams struct {
	...
	*/
	APIVersion string
	/*Body*/
	Body *models.InstalledExtension
	/*Organization
...
func (o *UpdateParams) WithBody(body *models.InstalledExtension) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.InstalledExtension) {
	o.Body = body
}
