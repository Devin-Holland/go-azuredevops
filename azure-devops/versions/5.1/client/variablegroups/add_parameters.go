...
func (o *AddParams) WithBody(body *models.VariableGroupParameters) *AddParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add params
func (o *AddParams) SetBody(body *models.VariableGroupParameters) {
	o.Body = body
}
