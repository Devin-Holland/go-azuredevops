...
// WithGroupID adds the groupID to the delete params
func (o *DeleteParams) WithGroupID(groupID int32) *DeleteParams {
	o.SetGroupID(groupID)
	return o
}

// SetGroupID adds the groupId to the delete params
func (o *DeleteParams) SetGroupID(groupID int32) {
	o.GroupID = groupID
}
