...
// WithGroupID adds the groupID to the get params
func (o *GetParams) WithGroupID(groupID int32) *GetParams {
	o.SetGroupID(groupID)
	return o
}

// SetGroupID adds the groupId to the get params
func (o *GetParams) SetGroupID(groupID int32) {
	o.GroupID = groupID
}
