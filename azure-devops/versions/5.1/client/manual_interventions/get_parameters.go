...
// WithManualInterventionID adds the manualInterventionID to the get params
func (o *GetParams) WithManualInterventionID(manualInterventionID int32) *GetParams {
	o.SetManualInterventionID(manualInterventionID)
	return o
}

// SetManualInterventionID adds the manualInterventionId to the get params
func (o *GetParams) SetManualInterventionID(manualInterventionID int32) {
...
// WithReleaseID adds the releaseID to the get params
func (o *GetParams) WithReleaseID(releaseID int32) *GetParams {
	o.SetReleaseID(releaseID)
	return o
}

// SetReleaseID adds the releaseId to the get params
func (o *GetParams) SetReleaseID(releaseID int32) {
