...
type UpdateParams struct {
	...
	*/
	Body *models.ManualInterventionUpdateMetadata
	/*ManualInterventionID
	  Id of the manual intervention.

	*/
	ManualInterventionID int32
	/*Organization
...
func (o *UpdateParams) WithBody(body *models.ManualInterventionUpdateMetadata) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.ManualInterventionUpdateMetadata) {
	o.Body = body
}

// WithManualInterventionID adds the manualInterventionID to the update params
func (o *UpdateParams) WithManualInterventionID(manualInterventionID int32) *UpdateParams {
	o.SetManualInterventionID(manualInterventionID)
	return o
}

// SetManualInterventionID adds the manualInterventionId to the update params
func (o *UpdateParams) SetManualInterventionID(manualInterventionID int32) {
	o.ManualInterventionID = manualInterventionID
}
...
// WithReleaseID adds the releaseID to the update params
func (o *UpdateParams) WithReleaseID(releaseID int32) *UpdateParams {
	o.SetReleaseID(releaseID)
	return o
}

// SetReleaseID adds the releaseId to the update params
func (o *UpdateParams) SetReleaseID(releaseID int32) {
...
func (o *UpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param manualInterventionId
	if err := r.SetPathParam("manualInterventionId", swag.FormatInt32(o.ManualInterventionID)); err != nil {
		return err
	}
