...
type UpdateOK struct {
	Payload *models.ManualIntervention
}

func (o *UpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /{organization}/{project}/_apis/Release/releases/{releaseId}/manualinterventions/{manualInterventionId}][%d] updateOK  %+v", 200, o.Payload)
}

func (o *UpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ManualIntervention)
