...
// WithReleaseID adds the releaseID to the list params
func (o *ListParams) WithReleaseID(releaseID int32) *ListParams {
	o.SetReleaseID(releaseID)
	return o
}

// SetReleaseID adds the releaseId to the list params
func (o *ListParams) SetReleaseID(releaseID int32) {
