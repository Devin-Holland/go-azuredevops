...
// WithUserDescriptor adds the userDescriptor to the get params
func (o *GetParams) WithUserDescriptor(userDescriptor string) *GetParams {
	o.SetUserDescriptor(userDescriptor)
	return o
}

// SetUserDescriptor adds the userDescriptor to the get params
func (o *GetParams) SetUserDescriptor(userDescriptor string) {
