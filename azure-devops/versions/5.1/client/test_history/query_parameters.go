...
func (o *QueryParams) WithBody(body *models.TestHistoryQuery) *QueryParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the query params
func (o *QueryParams) SetBody(body *models.TestHistoryQuery) {
	o.Body = body
}
