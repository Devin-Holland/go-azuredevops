...
*/
type QueryOK struct {
	Payload *models.TestHistoryQuery
}

func (o *QueryOK) Error() string {
	return fmt.Sprintf("[POST /{organization}/{project}/_apis/test/Results/testhistory][%d] queryOK  %+v", 200, o.Payload)
}

func (o *QueryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.TestHistoryQuery)
