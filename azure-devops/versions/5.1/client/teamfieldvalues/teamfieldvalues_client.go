...
// New creates a new teamfieldvalues API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Client {
	return &Client{transport: transport, formats: formats}
}

/*
Client for teamfieldvalues API
*/
type Client struct {
...
/*
Get Get a collection of team field values
*/
func (a *Client) Get(params *GetParams, authInfo runtime.ClientAuthInfoWriter) (*GetOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "Get",
		Method:             "GET",
		PathPattern:        "/{organization}/{project}/{team}/_apis/work/teamsettings/teamfieldvalues",
...
/*
Update Update team field values
*/
