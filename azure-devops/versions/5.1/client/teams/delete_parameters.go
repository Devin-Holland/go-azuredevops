...
// WithProjectID adds the projectID to the delete params
func (o *DeleteParams) WithProjectID(projectID string) *DeleteParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the delete params
func (o *DeleteParams) SetProjectID(projectID string) {
	o.ProjectID = projectID
}

// WithTeamID adds the teamID to the delete params
func (o *DeleteParams) WithTeamID(teamID string) *DeleteParams {
	o.SetTeamID(teamID)
	return o
}

// SetTeamID adds the teamId to the delete params
func (o *DeleteParams) SetTeamID(teamID string) {
	o.TeamID = teamID
}
