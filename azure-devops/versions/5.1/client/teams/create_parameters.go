...
func (o *CreateParams) WithBody(body *models.WebAPITeam) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.WebAPITeam) {
	o.Body = body
}
...
// WithProjectID adds the projectID to the create params
func (o *CreateParams) WithProjectID(projectID string) *CreateParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the create params
