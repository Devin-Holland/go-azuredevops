...
type GetParams struct {
	...
	*/
	Organization string
	/*Select
	  Comma (",") separated list of properties to select. Supported property names are {AccessLevels, Licenses, Extensions, Projects, Groups}.
...
// WithSelect adds the selectVar to the get params
func (o *GetParams) WithSelect(selectVar *string) *GetParams {
	o.SetSelect(selectVar)
	return o
}

// SetSelect adds the select to the get params
func (o *GetParams) SetSelect(selectVar *string) {
	o.Select = selectVar
}
