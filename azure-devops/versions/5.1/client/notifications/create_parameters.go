...
func (o *CreateParams) WithBody(body *models.Notification) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.Notification) {
	o.Body = body
}
...
// WithUseRealData adds the useRealData to the create params
func (o *CreateParams) WithUseRealData(useRealData *bool) *CreateParams {
	o.SetUseRealData(useRealData)
	return o
}

// SetUseRealData adds the useRealData to the create params
func (o *CreateParams) SetUseRealData(useRealData *bool) {
	o.UseRealData = useRealData
}
...
func (o *CreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.UseRealData != nil {

		// query param useRealData
		var qrUseRealData bool
		if o.UseRealData != nil {
			qrUseRealData = *o.UseRealData
		}
		qUseRealData := swag.FormatBool(qrUseRealData)
		if qUseRealData != "" {
			if err := r.SetQueryParam("useRealData", qUseRealData); err != nil {
				return err
			}
		}
