...
type QueryParams struct {
	...
	*/
	APIVersion string
	/*Body*/
	Body *models.NotificationsQuery
	/*Organization
...
func (o *QueryParams) WithBody(body *models.NotificationsQuery) *QueryParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the query params
func (o *QueryParams) SetBody(body *models.NotificationsQuery) {
	o.Body = body
}
