...
*/
type QueryOK struct {
	Payload *models.NotificationsQuery
}

func (o *QueryOK) Error() string {
	return fmt.Sprintf("[POST /{organization}/_apis/hooks/notificationsquery][%d] queryOK  %+v", 200, o.Payload)
}

func (o *QueryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NotificationsQuery)
