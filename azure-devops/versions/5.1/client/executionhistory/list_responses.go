...
*/
type ListOK struct {
	Payload []*models.ServiceEndpointExecutionRecord
}

func (o *ListOK) Error() string {
	return fmt.Sprintf("[GET /{organization}/{project}/_apis/serviceendpoint/{endpointId}/executionhistory][%d] listOK  %+v", 200, o.Payload)
}
