...
type UpdateOK struct {
	Payload []*models.DeploymentMachine
}

func (o *UpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /{organization}/{project}/_apis/distributedtask/deploymentgroups/{deploymentGroupId}/targets][%d] updateOK  %+v", 200, o.Payload)
}
