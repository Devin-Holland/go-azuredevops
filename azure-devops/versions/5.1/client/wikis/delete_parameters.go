...
// WithWikiIdentifier adds the wikiIdentifier to the delete params
func (o *DeleteParams) WithWikiIdentifier(wikiIdentifier string) *DeleteParams {
	o.SetWikiIdentifier(wikiIdentifier)
	return o
}

// SetWikiIdentifier adds the wikiIdentifier to the delete params
func (o *DeleteParams) SetWikiIdentifier(wikiIdentifier string) {
