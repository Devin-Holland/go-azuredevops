...
*/
type QueryOK struct {
	Payload *models.AuditLogQueryResult
}

func (o *QueryOK) Error() string {
	return fmt.Sprintf("[GET /{organization}/_apis/audit/auditlog][%d] queryOK  %+v", 200, o.Payload)
}

func (o *QueryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.AuditLogQueryResult)
