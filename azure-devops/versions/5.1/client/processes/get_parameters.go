...
// WithDollarExpand adds the dollarExpand to the get params
func (o *GetParams) WithDollarExpand(dollarExpand *string) *GetParams {
	o.SetDollarExpand(dollarExpand)
	return o
}

// SetDollarExpand adds the dollarExpand to the get params
func (o *GetParams) SetDollarExpand(dollarExpand *string) {
...
// WithProcessTypeID adds the processTypeID to the get params
func (o *GetParams) WithProcessTypeID(processTypeID strfmt.UUID) *GetParams {
	o.SetProcessTypeID(processTypeID)
	return o
}

// SetProcessTypeID adds the processTypeId to the get params
func (o *GetParams) SetProcessTypeID(processTypeID strfmt.UUID) {
