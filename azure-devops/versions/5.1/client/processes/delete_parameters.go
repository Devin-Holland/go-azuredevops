...
// WithProcessTypeID adds the processTypeID to the delete params
func (o *DeleteParams) WithProcessTypeID(processTypeID strfmt.UUID) *DeleteParams {
	o.SetProcessTypeID(processTypeID)
	return o
}

// SetProcessTypeID adds the processTypeId to the delete params
func (o *DeleteParams) SetProcessTypeID(processTypeID strfmt.UUID) {
