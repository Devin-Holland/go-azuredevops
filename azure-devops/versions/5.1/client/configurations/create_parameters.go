...
func (o *CreateParams) WithBody(body *models.PolicyConfiguration) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.PolicyConfiguration) {
	o.Body = body
}

// WithConfigurationID adds the configurationID to the create params
func (o *CreateParams) WithConfigurationID(configurationID int32) *CreateParams {
	o.SetConfigurationID(configurationID)
	return o
}

// SetConfigurationID adds the configurationId to the create params
func (o *CreateParams) SetConfigurationID(configurationID int32) {
