...
// WithConfigurationID adds the configurationID to the delete params
func (o *DeleteParams) WithConfigurationID(configurationID int32) *DeleteParams {
	o.SetConfigurationID(configurationID)
	return o
}

// SetConfigurationID adds the configurationId to the delete params
func (o *DeleteParams) SetConfigurationID(configurationID int32) {
