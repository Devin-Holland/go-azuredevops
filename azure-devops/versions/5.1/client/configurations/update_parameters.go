...
type UpdateParams struct {
	...
	*/
	Body *models.PolicyConfiguration
	/*ConfigurationID
...
func (o *UpdateParams) WithBody(body *models.PolicyConfiguration) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.PolicyConfiguration) {
	o.Body = body
}

// WithConfigurationID adds the configurationID to the update params
func (o *UpdateParams) WithConfigurationID(configurationID int32) *UpdateParams {
	o.SetConfigurationID(configurationID)
	return o
}

// SetConfigurationID adds the configurationId to the update params
func (o *UpdateParams) SetConfigurationID(configurationID int32) {
...
func (o *UpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if err := r.SetPathParam("configurationId", swag.FormatInt32(o.ConfigurationID)); err != nil {
		return err
	}
