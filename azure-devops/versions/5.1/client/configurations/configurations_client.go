...
/*
Create Create a policy configuration of a given policy type.
*/
func (a *Client) Create(params *CreateParams, authInfo runtime.ClientAuthInfoWriter) (*CreateOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "Create",
		Method:             "POST",
		PathPattern:        "/{organization}/{project}/_apis/policy/configurations/{configurationId}",
...
/*
Delete Delete a policy configuration by its ID.
*/
...
/*
Update Update a policy configuration by its ID.
*/
