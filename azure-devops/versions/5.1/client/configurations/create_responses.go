...
type CreateOK struct {
	Payload *models.PolicyConfiguration
}

func (o *CreateOK) Error() string {
	return fmt.Sprintf("[POST /{organization}/{project}/_apis/policy/configurations/{configurationId}][%d] createOK  %+v", 200, o.Payload)
}

func (o *CreateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PolicyConfiguration)
