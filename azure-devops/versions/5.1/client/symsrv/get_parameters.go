...
// WithDebugEntryClientKey adds the debugEntryClientKey to the get params
func (o *GetParams) WithDebugEntryClientKey(debugEntryClientKey string) *GetParams {
	o.SetDebugEntryClientKey(debugEntryClientKey)
	return o
}

// SetDebugEntryClientKey adds the debugEntryClientKey to the get params
func (o *GetParams) SetDebugEntryClientKey(debugEntryClientKey string) {
	o.DebugEntryClientKey = debugEntryClientKey
}
...
func (o *GetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param debugEntryClientKey
	if err := r.SetPathParam("debugEntryClientKey", o.DebugEntryClientKey); err != nil {
		return err
	}
