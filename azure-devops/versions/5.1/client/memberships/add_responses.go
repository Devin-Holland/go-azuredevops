...
*/
type AddOK struct {
	Payload *models.GraphMembership
}

func (o *AddOK) Error() string {
	return fmt.Sprintf("[PUT /{organization}/_apis/graph/memberships/{subjectDescriptor}/{containerDescriptor}][%d] addOK  %+v", 200, o.Payload)
}

func (o *AddOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GraphMembership)
