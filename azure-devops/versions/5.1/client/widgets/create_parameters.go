...
func (o *CreateParams) WithBody(body *models.Widget) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.Widget) {
	o.Body = body
}

// WithDashboardID adds the dashboardID to the create params
func (o *CreateParams) WithDashboardID(dashboardID strfmt.UUID) *CreateParams {
	o.SetDashboardID(dashboardID)
	return o
}

// SetDashboardID adds the dashboardId to the create params
func (o *CreateParams) SetDashboardID(dashboardID strfmt.UUID) {
...
// WithTeam adds the team to the create params
func (o *CreateParams) WithTeam(team string) *CreateParams {
	o.SetTeam(team)
	return o
}

// SetTeam adds the team to the create params
func (o *CreateParams) SetTeam(team string) {
	o.Team = team
}
