...
// WithDashboardID adds the dashboardID to the delete params
func (o *DeleteParams) WithDashboardID(dashboardID strfmt.UUID) *DeleteParams {
	o.SetDashboardID(dashboardID)
	return o
}

// SetDashboardID adds the dashboardId to the delete params
func (o *DeleteParams) SetDashboardID(dashboardID strfmt.UUID) {
...
// WithWidgetID adds the widgetID to the delete params
func (o *DeleteParams) WithWidgetID(widgetID strfmt.UUID) *DeleteParams {
	o.SetWidgetID(widgetID)
	return o
}

// SetWidgetID adds the widgetId to the delete params
func (o *DeleteParams) SetWidgetID(widgetID strfmt.UUID) {
	o.WidgetID = widgetID
}
