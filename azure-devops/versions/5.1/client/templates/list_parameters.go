...
// WithWorkitemtypename adds the workitemtypename to the list params
func (o *ListParams) WithWorkitemtypename(workitemtypename *string) *ListParams {
	o.SetWorkitemtypename(workitemtypename)
	return o
}

// SetWorkitemtypename adds the workitemtypename to the list params
func (o *ListParams) SetWorkitemtypename(workitemtypename *string) {
	o.Workitemtypename = workitemtypename
}
...
func (o *ListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Workitemtypename != nil {

		// query param workitemtypename
		var qrWorkitemtypename string
		if o.Workitemtypename != nil {
			qrWorkitemtypename = *o.Workitemtypename
		}
		qWorkitemtypename := qrWorkitemtypename
		if qWorkitemtypename != "" {
			if err := r.SetQueryParam("workitemtypename", qWorkitemtypename); err != nil {
				return err
			}
		}
