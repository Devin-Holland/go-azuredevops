...
// WithTemplateID adds the templateID to the delete params
func (o *DeleteParams) WithTemplateID(templateID strfmt.UUID) *DeleteParams {
	o.SetTemplateID(templateID)
	return o
}

// SetTemplateID adds the templateId to the delete params
func (o *DeleteParams) SetTemplateID(templateID strfmt.UUID) {
