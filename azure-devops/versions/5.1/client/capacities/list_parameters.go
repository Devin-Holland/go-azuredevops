...
// WithIterationID adds the iterationID to the list params
func (o *ListParams) WithIterationID(iterationID strfmt.UUID) *ListParams {
	o.SetIterationID(iterationID)
	return o
}

// SetIterationID adds the iterationId to the list params
func (o *ListParams) SetIterationID(iterationID strfmt.UUID) {
