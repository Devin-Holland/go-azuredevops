...
func (o *AddParams) WithBody(body []*models.TestCaseResult) *AddParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add params
func (o *AddParams) SetBody(body []*models.TestCaseResult) {
	o.Body = body
}
...
// WithRunID adds the runID to the add params
func (o *AddParams) WithRunID(runID int32) *AddParams {
	o.SetRunID(runID)
	return o
}

// SetRunID adds the runId to the add params
func (o *AddParams) SetRunID(runID int32) {
	o.RunID = runID
}
